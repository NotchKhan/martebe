...
// Some legacy menu imports assigned descriptions from neighbouring categories
// (for example, sauce descriptions to drinks). Keep the corrections together
// so every supported language receives a category-appropriate description.
const DESCRIPTION_PREFIXES = {
  grill: {
    kz: 'Грильде дайындалған тағам', en: 'Grilled dish', zh: '炭烤菜品',
    hi: 'ग्रिल पर तैयार व्यंजन', ja: 'グリル料理'
  },
  sauce: {
    kz: 'Ыстық тағамдар мен тіскебасарларға арналған соус', en: 'Sauce for hot dishes and appetizers',
    zh: '适合热菜和小吃的酱料', hi: 'गरम व्यंजनों और स्नैक्स के लिए सॉस', ja: '温かい料理や前菜に合うソース'
  },
  garnish: {
    kz: 'Негізгі тағамға арналған гарнир', en: 'Side dish for the main course', zh: '主菜配菜',
    hi: 'मुख्य व्यंजन के लिए साइड डिश', ja: 'メイン料理の付け合わせ'
  },
  bakery: {
    kz: 'Жаңа піскен нан өнімі', en: 'Freshly baked item', zh: '新鲜烘焙食品',
    hi: 'ताज़ा बेक किया हुआ व्यंजन', ja: '焼きたてのパン料理'
  },
  assorted: {
    kz: 'Компанияға арналған ассорти', en: 'Assortment for a group', zh: '适合聚会分享的拼盘',
    hi: 'समूह के लिए मिश्रित प्लेटर', ja: 'グループ向け盛り合わせ'
  },
  banquet: {
    kz: 'Компанияға арналған банкет тағамы', en: 'Banquet dish for a group', zh: '适合聚会的宴会菜品',
    hi: 'समूह के लिए भोज व्यंजन', ja: 'グループ向け宴会料理'
  },
  drink: {
    kz: 'Сергітетін сусын', en: 'Refreshing drink', zh: '清爽饮品',
    hi: 'ताज़गीभरा पेय', ja: '爽やかなドリンク'
  }
};

const MENU_DESCRIPTION_REPAIRS = {
  601: ['grill', 'Сочный стейк из мраморной говядины, приготовленный на гриле.'],
  602: ['grill', 'Нежный мясной медальон, обжаренный до румяной корочки.'],
  603: ['grill', 'Сочный медальон из куриного филе, приготовленный на гриле.'],
  604: ['grill', 'Маринованные куриные крылышки, обжаренные на мангале.'],
  608: ['grill', 'Свежие овощи, запечённые на мангале до лёгкой румяности.'],
  609: ['grill', 'Маринованные куриные окорочка, приготовленные на мангале.'],

  704: ['sauce', 'Нежный сырный соус с мягким сливочным вкусом.'],
  705: ['sauce', 'Классический майонез для салатов, закусок и горячих блюд.'],
  706: ['sauce', 'Классический томатный кетчуп для закусок и горячих блюд.'],
  707: ['garnish', 'Рассыпчатый отварной рис — лёгкий гарнир к основному блюду.'],
  708: ['garnish', 'Нежное картофельное пюре со сливочным вкусом.'],
  709: ['garnish', 'Хрустящие картофельные шарики с мягкой начинкой внутри.'],

  804: ['bakery', 'Хрустящая самса с сочной куриной начинкой, выпеченная в тандыре.'],
  805: ['bakery', 'Шесть свежих воздушных баурсаков, обжаренных до золотистой корочки.'],

  810: ['assorted', 'Ассорти традиционного хлеба и свежей выпечки, поданное на астау.'],
  901: ['assorted', 'Ассорти из разных частей курицы, приготовленных на мангале.'],
  902: ['assorted', 'Большое ассорти из разных видов мяса для компании.'],
  903: ['assorted', 'Малое ассорти из разных видов мяса для компании.'],
  904: ['assorted', 'Большая нарезка из свежих сезонных овощей и зелени.'],
  905: ['assorted', 'Нарезка из свежих сезонных фруктов для компании.'],

  1001: ['banquet', 'Бешбармак с отварным мясом, жаймой и бульоном на компанию из 6–8 человек.'],
  1002: ['banquet', 'Большой бешбармак с отварным мясом, жаймой и бульоном на 10–12 человек.'],
  1003: ['banquet', 'Казан-кебаб с сочным мясом и картофелем, поданный на большом астау.'],
  1004: ['banquet', 'Сытный куырдак из мяса и картофеля на компанию из 9–10 человек.'],

  1101: ['drink', 'Чистая негазированная питьевая вода, 0,5 л.'],
  1102: ['drink', 'Чистая негазированная питьевая вода, 1 л.'],
  1103: ['drink', 'Освежающая газированная питьевая вода.'],
  1104: ['drink', 'Охлаждённый напиток каркаде с ярким вкусом гибискуса, 0,5 л.'],
  1105: ['drink', 'Охлаждённый напиток каркаде с ярким вкусом гибискуса, 1 л.'],
  1106: ['drink', 'Традиционный освежающий кисломолочный напиток коже, 0,5 л.'],
  1107: ['drink', 'Охлаждённая Coca-Cola в жестяной банке.'],
  1108: ['drink', 'Охлаждённая Coca-Cola на розлив.'],
  1109: ['drink', 'Охлаждённая Coca-Cola в стеклянной бутылке.'],
  1111: ['drink', 'Натуральный сок Piko в упаковке 1 л.'],
  1112: ['drink', 'Охлаждённый чай FuseTea в бутылке 0,5 л.'],
  1113: ['drink', 'Охлаждённый чай FuseTea в бутылке 1 л.'],
  1114: ['drink', 'Охлаждённая Coca-Cola в бутылке 0,5 л.'],
  1115: ['drink', 'Охлаждённая Fanta с апельсиновым вкусом, 0,5 л.'],
  1116: ['drink', 'Охлаждённый Sprite со вкусом лимона и лайма, 0,5 л.'],
  1117: ['drink', 'Охлаждённая Coca-Cola в бутылке 1 л.'],
  1118: ['drink', 'Охлаждённая Fanta с апельсиновым вкусом, 1 л.'],
  1119: ['drink', 'Охлаждённый Sprite со вкусом лимона и лайма, 1 л.']
};

for (const [id, [kind, ruDescription]] of Object.entries(MENU_DESCRIPTION_REPAIRS)) {
  const item = MENU.find(menuItem => menuItem.id === Number(id));
  const prefixes = DESCRIPTION_PREFIXES[kind];
  if (!item || !prefixes) continue;

  item.desc = { ru: ruDescription };
  for (const lang of ['kz', 'en', 'zh', 'hi', 'ja']) {
    const localizedName = item.name[lang] || item.name.ru;
    item.desc[lang] = `${prefixes[lang]}: ${localizedName}.`;
  }
}
